...
export default neurodeskViteConfig({appId:'syncro',plugins:[assets(),isolationFallback()],define:{__SYNCRO_PACKAGE_VERSION__:JSON.stringify(syncroPackage.version)},build:{target:'esnext'},optimizeDeps:{exclude:['onnxruntime-web','@neurodesk/runtime-support/niimath']},server:{host:'127.0.0.1',port:5175},preview:{host:'127.0.0.1',port:5175}});
